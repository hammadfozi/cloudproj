...
<header style="margin-bottom: 60px">
    <nav class="navbar navbar-dark black navbar-fixed-top scrolling-navbar"
         role="navigation">
        <div class="container-fluid" style="">
            <div class="navbar-header">
                <a class="navbar-brand" href="<c:url value="/" />" style="margin-top: -12px"><span
                        class="material-red-text" style="font-weight: 900;font-size: 40px">Rukus Hotel
                    <span style="font-weight: 100">ADMIN PANEL</span></span></a>
            </div>
