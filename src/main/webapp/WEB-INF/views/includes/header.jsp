        ...
        <div class="container-fluid" style="">
            <div class="navbar-header">
                <a class="navbar-brand" href="<c:url value="/" />" style="margin-top: -12px">
                    <span class="material-red-text" style="font-weight: 800;font-size: 38px">Rukus Hotel</span></a>
            </div>
                    ...
                    <sec:authorize access="isAnonymous()">
                        <li class="nav-item">
                            <a href="<c:url value="/login" />">
                                <button id="login" type="button" class="btn-primary waves-button material-red"
